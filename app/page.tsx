              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="p-6 space-y-4 hover:bg-muted/50 transition-colors">
                  <div className="flex items-center space-x-2">
                    ...
                    <h3 className="text-xl font-semibold">Real-Time Visual Assistance</h3>
                  </div>
                  <p>Our AI analyzes your surroundings, providing instant feedback and guidance.</p>
                </Card>
                <Card className="p-6 space-y-4 hover:bg-muted/50 transition-colors">
                  <div className="flex items-center space-x-2">
                    <MessageSquareText className="w-6 h-6 text-primary" />
                    <h3 className="text-xl font-semibold">Natural Voice Interaction</h3>
                  </div>
                  <p>Communicate with the AI using natural voice commands and receive clear, spoken responses.</p>
                </Card>
                <Card className="p-6 space-y-4 hover:bg-muted/50 transition-colors">
                  <div className="flex items-center space-x-2">
                    <Lightbulb className="w-6 h-6 text-primary" />
                    <h3 className="text-xl font-semibold">Personalized Task Guidance</h3>
                  </div>
                  <p>Get step-by-step instructions and support for daily tasks, tailored to your needs.</p>
                </Card>
              </div>
            </section>
