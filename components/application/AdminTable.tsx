        ...
        <div className="relative">
            ...
            {open && (
                <div className="absolute right-0 z-10 mt-2 w-36 bg-white border rounded shadow-lg">
                    <button
                        disabled={vol.role === "SUPER_ADMIN"}
                        className="block w-full text-left px-4 py-2 hover:bg-gray-100 text-red-600 disabled:cursor-not-allowed disabled:line-through"
                        onClick={() => {
                            setOpen(false);
                            onDelete();
                        }}
                    ...
                    <button
                        disabled={vol.role === "SUPER_ADMIN"}
                        className="block w-full text-left px-4 py-2 hover:bg-gray-100 whitespace-nowrap disabled:cursor-not-allowed disabled:line-through"
                        onClick={() => {
                            setOpen(false);
                            onToggleActive();
                        }}
